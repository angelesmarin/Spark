...
# Define the search space boundaries for x and y dimensions
...
dataset = read_dataset('/Users/angelesmarin/Desktop/dataset.csv')

labels = set(row['class'] for row in dataset)
centroids = {label: compute_centroids(dataset, label) for label in labels}
